...
if __name__ == '__main__':
    ...
    benchmark = Benchmark('team35_A1', count=5, comparing_models = ["greedy_player"], board_sizes=["empty-2x2.txt", "empty-2x3.txt", "empty-3x3.txt"])


    # All results are then computed and timed
    start = time.perf_counter()
    results = benchmark.compute_benchmark_results()
