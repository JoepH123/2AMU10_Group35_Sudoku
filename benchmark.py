...
if __name__ == '__main__':
    ...
    # benchmark_10_standard = Benchmark('team35_current_best', count=10, comparing_models = ["greedy_player", "team35_with_randomness", "team35_A0"], board_sizes=["empty-2x2.txt", "empty-2x3.txt", "empty-3x3.txt", "empty-3x4.txt", "empty-4x4.txt"])
    ...
    results = benchmark_2_testing.compute_benchmark_results()
